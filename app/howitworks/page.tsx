export default function HowItWorks() {
  return (
    <div className="relative min-h-screen bg-white selection:bg-green-500/20 overflow-hidden dark:bg-zinc-900 dark:text-white">
      {/* Gradient Background */}
      ...
      <main className="relative px-6 pt-32">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="inline-flex h-9 items-center gap-2 rounded-full border border-green-500/20 bg-green-500/10 px-4 text-sm text-green-400 dark:bg-green-500/20 dark:text-green-400">
              <svg
                className="h-4 w-4"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-zinc-400 dark:text-zinc-300">
          ...
          <div className="mt-24 grid gap-12">
            {[
              ...
              <div
                key={i}
                className="group relative overflow-hidden rounded-2xl bg-white border p-8 transition-all hover:bg-zinc-100 dark:bg-zinc-800 dark:hover:bg-zinc-700"
              >
                ...
                <div className="relative flex gap-6">
                  ...
                  <div>
                    <div className="text-sm font-medium text-green-500 dark:text-green-300">
                      Step {step.step}
                    </div>
                    <h3 className="mt-2 text-xl font-medium text-zinc-800 dark:text-zinc-100">
                      {step.title}
                    </h3>
          ...
          {/* Security Features */}
          <div className="mt-24 rounded-2xl p-8 dark:bg-zinc-800 border bg-white">
            <h2 className="text-2xl font-bold text-gray-800 text-center mb-8 dark:text-zinc-100">
              Security Measures
            </h2>
              ...
              {[
                ...
                <div key={i} className="text-center p-6">
                  <div className="flex justify-center mb-4">
                    <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-sky-500/10 dark:bg-sky-500/20">
                      {feature.icon}
                    </div>
                  </div>
                  <h3 className="text-lg font-medium text-gray-800 mb-2 dark:text-zinc-100">
                    {feature.title}
                  </h3>
