...
//     const allowedTypes = ["Wildfire", "Earthquake", "Hurricane", "Flood", "Tornado", "Tsunami", "Landslide"] as const;
//     if (!allowedTypes.includes(reportType as any)) {
