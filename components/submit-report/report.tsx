...
export function ReportLayout() {
  ...
  return (
    <div
      className="rounded-2xl md:shadow-lg lg:shadow-lg bg-white border border-gray-400 dark:border-gray-700 md:bg-gray-100 lg:bg-gray-100 dark:bg-black/90 
  p-4 md:p-8 lg:p-8 transition-all duration-300"
    >
